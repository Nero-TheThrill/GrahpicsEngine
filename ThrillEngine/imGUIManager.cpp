        ...
        {
            {
                ...
                ImGui::Separator();
                bool visaulize = center_obj->material == GRAPHICS->GetMaterial("m_test");
                ImGui::Checkbox("Visualize UV", &visaulize);
                if (visaulize)
                {
                    center_obj->material = GRAPHICS->GetMaterial("m_test");
                }
                else
                {
                    center_obj->material = GRAPHICS->GetMaterial("m_centerobj");
                }
